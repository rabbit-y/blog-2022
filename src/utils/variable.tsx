...
export const ABOUTLINK = [
  {
    ...
    image: `${COS_URL}blog/headers/wechat.png`,
  },
  {
    name: 'qq',
    icon: <IconFont type="h-qq" />,
    image: `${COS_URL}blog/headers/qq.png`,
  },
  {
    name: 'xiaochengxu',
    icon: <IconFont type="h-xiaochengxu" />,
    image: `${COS_URL}blog/headers/xcx.jpeg`,
  },
  {
    name: 'gitee',
...
export const LISTENLIST = [
  {
    ...
    cover: 'https://p2.music.126.net/J9_j9s2faIKwn6oqwQV2Rw==/109951166153759329.jpg?param=130y130',
  },
  {
    name: '哪里都是你',
    artist: '队长',
